...
impl Ticket {
    pub fn new(title: String, description: String, status: String) -> Ticket {
        <Ticket as Validate>::validate_title(&title);
        <Ticket as Validate>::validate_description(&description);
        <Ticket as Validate>::validate_status(&status);
